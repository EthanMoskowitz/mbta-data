...
def testGetSubwayStops():
    ...
    assert getSubwayStops(mockRedLine) == mockRedLineStops
...
def testFindMaxStops():
    ...
    result1, result2 = findMaxStops(twoRoutes)
...
def testFindMinStops():
    ...
    # get results from function with created routes
    result1, result2 = findMinStops(twoRoutes)
...
def testGetStopsWithRoutes():
    ...
    assert getStopsWithRoutes(mockOrangeBlue) == orangeBlueStops